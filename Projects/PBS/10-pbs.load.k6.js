...
- Smoke:
    k6 run --env BASE_URL=https://pbs-qa2.hosted.positive.co.uk --env SCENARIO=smoke PBS/10-pbs.load.k6.js
- Load:
    k6 run --env BASE_URL=https://pbs-qa2.hosted.positive.co.uk --env SCENARIO=load PBS/10-pbs.load.k6.js
- Spike:
    k6 run --env BASE_URL=https://pbs-qa2.hosted.positive.co.uk --env SCENARIO=spike PBS/10-pbs.load.k6.js
- Soak:
    k6 run --env BASE_URL=https://pbs-qa2.hosted.positive.co.uk --env SCENARIO=soak PBS/10-pbs.load.k6.js
- All scenarios:
    k6 run --env BASE_URL=https://pbs-qa2.hosted.positive.co.uk PBS/10-pbs.load.k6.js

From the PBS folder (cd .../Projects/PBS):
- Smoke:
    k6 run --env BASE_URL=https://pbs-qa2.hosted.positive.co.uk --env SCENARIO=smoke 10-pbs.load.k6.js
- Load:
    k6 run --env BASE_URL=https://pbs-qa2.hosted.positive.co.uk --env SCENARIO=load 10-pbs.load.k6.js
- Spike:
    k6 run --env BASE_URL=https://pbs-qa2.hosted.positive.co.uk --env SCENARIO=spike 10-pbs.load.k6.js
- Soak:
    k6 run --env BASE_URL=https://pbs-qa2.hosted.positive.co.uk --env SCENARIO=soak 10-pbs.load.k6.js
- All scenarios:
    k6 run --env BASE_URL=https://pbs-qa2.hosted.positive.co.uk 10-pbs.load.k6.js
