...
const FRIENDLY_FILE_NAMES = {
    ...
    '07-pbs.mortgages.spec.js': "Mortgage Products",
    '08-pbs.savings.spec.js': "Compare Savings Accounts",
    '09-pbs.mortgageguidesandsupport.spec.js': "Mortgages (Guides & Managing Your Mortgage)",
...
class FindingsReporter {
    ...
    buildWorkbook(timestamp) {
        ...
        workbook.creator = 'PBS QA Automation';
    ...
    addSummarySheet(workbook, timestamp) {
        ...
        sheet.addRow(['PBS Website - Test Findings']).font = { bold: true, size: 16 };
