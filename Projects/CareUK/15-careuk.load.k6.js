...
What this file does
-------------------
- Runs simple GET-only journeys against core Care UK pages.
...
export function browseCorePages() {
    ...
    requestAndCheck('/care-homes');
    sleep(Math.random() * 1 + 0.2);

    requestAndCheck('/where-do-i-start');
    sleep(Math.random() * 1 + 0.2);

    requestAndCheck('/types-of-care');
    sleep(Math.random() * 1 + 0.2);

    requestAndCheck('/our-approach-to-care');
    sleep(Math.random() * 1 + 0.2);

    requestAndCheck('/help-advice');
    sleep(Math.random() * 1 + 0.2);

    requestAndCheck('/company');
    sleep(Math.random() * 1 + 0.2);

    requestAndCheck('/careers');
    sleep(Math.random() * 1 + 0.2);
