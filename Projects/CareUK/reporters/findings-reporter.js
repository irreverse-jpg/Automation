...
const FRIENDLY_FILE_NAMES = {
    ...
    '05-careuk.carehomes.spec.js': "Homepage - Types of Care Carousel",
...
class FindingsReporter {
    ...
    buildWorkbook(timestamp) {
        ...
        workbook.creator = 'Care UK QA Automation';
    ...
    addSummarySheet(workbook, timestamp) {
        ...
        sheet.addRow(['Care UK Website - Test Findings']).font = { bold: true, size: 16 };
