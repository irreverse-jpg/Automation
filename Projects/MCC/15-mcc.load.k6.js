...
export function browseCorePages() {
    const pages = [
        { path: '/', label: 'homepage' },
        { path: '/lords/match-day/fixtures-and-results', label: 'fixtures-and-results' },
        { path: '/lords/lord-s-experience/tours', label: 'tours-and-museum' },
        { path: '/mcc/the-club/about-us', label: 'about-us' },
        { path: '/careers/vacancies', label: 'careers-vacancies' },
        { path: '/lords/visit-us/contact', label: 'contact' },
    ];
