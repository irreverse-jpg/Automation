...
async function runAxe(page, path, options = {}) {
    ...
    // #onetrust-consent-sdk: the cookie banner/preference-center overlay (see project memory for
    // its two distinct quirks) isn't part of the page's own content and can flash open/closed
    // asynchronously, which would make axe results depend on banner timing rather than the page.
